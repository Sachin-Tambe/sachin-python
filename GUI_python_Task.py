...
tk.Label(window, text="Python Project List", font=('Calisto MT', 20, 'bold')).place(x=150, y=50)
tk.Label(window, text="Made By Sachin Tambe", font=('Calisto MT', 10, 'bold')).place(x=200, y=100)


tk.Button(window,text="Addhar Update",font=('Calisto MT',8),command=addhar_update).place(x=50,y=150,height=50,width=100)
tk.Button(window,text="Tea Recommend ",font=('Calisto MT',8),command=Tea_recommender).place(x=200,y=150,height=50,width=100)
tk.Button(window,text="Laptop Recommend ",font=('Calisto MT',8),command=laptop_recomender).place(x=350,y=150,height=50,width=100)

tk.Button(window,text="Head Tail Game",font=('Calisto MT',8),command=head_tail_game).place(x=50,y=230,height=50,width=100)
tk.Button(window,text="Dice Game",font=('Calisto MT',8),command=dise_game).place(x=200,y=230,height=50,width=100)
tk.Button(window,text="Double Dice Game",font=('Calisto MT',8),command=double_dise_game).place(x=350,y=230,height=50,width=100)

tk.Button(window,text="Multiplication Tabel",font=('Calisto MT',8),command=multiplication_tabel).place(x=50,y=310,height=50,width=100)
tk.Button(window,text="Cube Of Number",font=('Calisto MT',8),command=cude_of_number).place(x=200,y=310,height=50,width=100)
tk.Button(window,text="Password Generator",font=('Calisto MT',8),command=password_generator).place(x=350,y=310,height=50,width=100)

tk.Button(window,text="Fibonacci",font=('Calisto MT',8),command=fabinoci).place(x=50,y=390,height=50,width=100)
tk.Button(window,text="Factorial ",font=('Calisto MT',8),command=factorial).place(x=200,y=390,height=50,width=100)
tk.Button(window,text="Countdown",font=('Calisto MT',8),command=coundown).place(x=350,y=390,height=50,width=100)
